...
<div id="page-head">
	...
	<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
	<div id="page-title">
		<h1 class="page-header text-overflow">Layer 3</h1>
...
<div class="col-md-12" ng-controller="layerCtrl">
 ...
 -->
							...
							<div class="col-md-12">	
								<h4 class="pull-left">Ảnh footer (width: 590px, height: 500px)</h4>	
								...
								<img id="img-layer" style="margin-top: 20px; border: 1px solid #dcdcdc" class="avatar img-responsive" width="590" height="500" ng-src="@{{ actions.loadImage(getData.avatar) }}" alt="">
							</div>
